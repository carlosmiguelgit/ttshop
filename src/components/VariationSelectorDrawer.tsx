...
interface VariationSelectorDrawerProps {
  ...
  onClose: () => void;
  product: Product;
  onConfirm: (quantity: number, action: 'cart' | 'buy') => void;
}
        ...
        <div className="mx-auto w-full max-w-[600px] flex flex-col h-full bg-white rounded-t-[16px] overflow-hidden">
          ...
          <div className="p-4 flex space-x-3 relative">
            ...
            <div className="flex flex-col justify-end pb-1 space-y-1">
              ...
              <div className="text-[12px] text-gray-900 font-medium">Selecionado: Padrão {selectedVariation + 1}</div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {product.media.slice(0, 2).map((item, idx) => (
                  ...
                  >
                    <img src={item.src} className="w-6 h-6 rounded-sm object-cover" />
                    <span className="text-[12px] font-medium">Padrão {idx + 1}</span>
                  </button>
                ))}
              </div>
            </div>
          ...
          {/* Botões de Ação IDENTICOS À FOTO */}
          <div className="p-4 border-t flex space-x-2">
            <Button
              ...
              onClick={() => onConfirm(quantity, 'cart')}
            >
            ...
            <Button
              ...
              onClick={() => onConfirm(quantity, 'buy')}
            >
