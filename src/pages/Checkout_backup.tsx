...
const CheckoutBackup: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8F8F8] pb-[200px] font-sans">
      ...
      <NoteDrawer isOpen={isNoteDrawerOpen} onClose={() => setIsNoteDrawerOpen(false)} onSave={() => {}} initialNote={orderNote} />
      <TikTokCouponDrawer isOpen={isCouponDrawerOpen} onClose={() => setIsCouponDrawerOpen(false)} onSelect={() => {}} selectedAmount={couponAmount} />
    </div>
  );
};
